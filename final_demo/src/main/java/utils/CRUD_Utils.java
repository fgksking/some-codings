    ...
    * */
    ...
    public static int executeUpdate(String sql, Object... params) {
        ...
        //*    con = JDBCutil.getconnection();*//*
            ...
            ConnectionPoolManager.releaseConnection(con);
        }
        return result;
    }

    public static int executeUpdate(String sql,Connection con, Object... params) {
        PreparedStatement stm = null;
        int result;
        try {
            stm = con.prepareStatement(sql);
...
* *//*     难点：如何从外部泛型类获取泛型对应的实例
   public static <T> T queryList(String sql, MyHander<T> hander, Object...params) {
        Connection con = null;
        PreparedStatement stm = null;
        Class<T> cls;
        try {
