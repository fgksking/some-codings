...
public class adminServlet extends BaseServlet{
    ...
    public ConnectionPoolManager connectionPoolManager = getConnectionPoolManager();
    ...
    public void get_error_trade(HttpServletRequest request, HttpServletResponse response)throws IOException{
        //检查交易异常行为
